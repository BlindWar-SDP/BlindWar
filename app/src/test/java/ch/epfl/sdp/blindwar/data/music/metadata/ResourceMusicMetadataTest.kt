...
class ResourceMusicMetadataTest: TestCase() {
    fun testTestToString() {
        ...
        val uriMetadata = ResourceMusicMetadata("Poker Face", "Lady Gaga", "", 0, 90)
        MatcherAssert.assertThat(uriMetadata.toString(), CoreMatchers.`is`(expected))
    }

    fun testGetTitle() {
        val expected = "Lady Gaga"
        val uriMetadata = ResourceMusicMetadata("Poker Face", "", "", 0, 90)
    ...
    fun testGetArtist() {
        ...
        val uriMetadata = ResourceMusicMetadata("", "Pink Floyd", "", 650000, 90)
    ...
    fun testGetImageUrl() {
        ...
        val uriMetadata = ResourceMusicMetadata("Shine On You Crazy Diamond", "Pink Floyd", "", 650000, 90)
    ...
    fun testGetResourceID() {
        val expected = 90
        val uriMetadata = ResourceMusicMetadata("Shine On You Crazy Diamond", "Pink Floyd", "", 650000, expected)
        MatcherAssert.assertThat(uriMetadata.resourceId, CoreMatchers.`is`(expected))
    }
}